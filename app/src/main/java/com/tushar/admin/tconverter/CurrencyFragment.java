...
public class CurrencyFragment extends Fragment {
    ...
    protected TextWatcher myTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().length() > 0) {
                et2.setText("" + Double.parseDouble(et1.getText().toString()) * 0.877783);
                et3.setText("" + Double.parseDouble(et1.getText().toString()) * 0.689545);
                et4.setText("" + Double.parseDouble(et1.getText().toString()) * 66.4997);
                et5.setText("" + Double.parseDouble(et1.getText().toString()) * 1.33873);
                et6.setText("" + Double.parseDouble(et1.getText().toString()) * 78.5756);
                et7.setText("" + Double.parseDouble(et1.getText().toString()) * 6.56267);
                et8.setText("" + Double.parseDouble(et1.getText().toString()) * 107.015);
            } else{
                et2.setText("");
                et3.setText("");
                et4.setText("");
    ...
    protected TextWatcher myTextWatcher1 = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().length() > 0) {
                ...
                et1.setText("" + Double.parseDouble(et2.getText().toString()) * 1.13971);
                et3.setText("" + Double.parseDouble(et2.getText().toString()) * 0.785249);
                et4.setText("" + Double.parseDouble(et2.getText().toString()) * 75.7522);
                et5.setText("" + Double.parseDouble(et2.getText().toString()) * 1.52242);
                et6.setText("" + Double.parseDouble(et2.getText().toString()) * 89.5416);
                et7.setText("" + Double.parseDouble(et2.getText().toString()) * 7.47745);
                et8.setText("" + Double.parseDouble(et2.getText().toString()) * 121.922);
            } else {
                et1.setText("");
                et3.setText("");
                et4.setText("");
    ...
    protected TextWatcher myTextWatcher2 = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().length() > 0) {
                ...
                et7.setText("" + Double.parseDouble(et3.getText().toString()) * 9.52406);
                et8.setText("" + Double.parseDouble(et3.getText().toString()) * 155.149);
            } else {
                et1.setText("");
                et2.setText("");
                et4.setText("");
    ...
    protected TextWatcher myTextWatcher3 = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().length() > 0) {
                ...
                et7.setText("" + Double.parseDouble(et4.getText().toString()) * 0.0987324);
                et8.setText("" + Double.parseDouble(et4.getText().toString()) * 1.60793);
            } else {
                et1.setText("");
                et2.setText("");
                et3.setText("");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragView = inflater.inflate(R.layout.fragment_currency, container, false);
        //((AppCompatActivity) getActivity()).getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#046403")));
        ...
        tv1.setText(Html.fromHtml("&#36"));
        tv2.setText(Html.fromHtml("&#8364"));
        tv3.setText(Html.fromHtml("&#163"));
        tv4.setText(Html.fromHtml("&#8377"));
        tv5.setText(Html.fromHtml("A&#36"));
        tv6.setText(Html.fromHtml("&#2547"));
        tv7.setText(Html.fromHtml("&#165"));
        tv8.setText(Html.fromHtml("&#165"));
